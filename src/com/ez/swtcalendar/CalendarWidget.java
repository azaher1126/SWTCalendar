...
public class CalendarWidget extends Composite {
	 ...
	 */
	public CalendarWidget(Composite parent, int style, HashMap<LocalDate, Integer> tasks, Settings settings) {
		super(parent, style);
		setLayout(null);
		this.tasks = tasks;
	...
	/**
	 * Adds a listener that fires when a day is selected.
	 * @param listener
	 */
	...
	/**
	 * Update CalandarWidget with new data.
	 * @param tasks gives the number of tasks for each day.
	 */
	...
	/**
	 * Widget settings
	 * @return the current settings used by the widget
	 */
